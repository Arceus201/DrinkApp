...
/**
 * Example Activity using Hilt DI with CategoryPresenterCoroutine
 * This demonstrates the pattern for migrating Activities to use Hilt
 * 
 * To use this:
 * 1. Rename this file to CategoryActivity.kt (backup the old one first)
 * 2. Update AndroidManifest.xml if needed
 * 3. Test thoroughly
 */
@AndroidEntryPoint
class CategoryActivityHilt :
    ...
    @Inject
    lateinit var presenter: CategoryPresenterCoroutine
    ...
    override fun onItemCategoryClick(pos: Int, category: Category) {
        ...
        binding.buttonSave.text = TEXT_UPDATE
